...
export function Footer() {
  return (
    <footer className="mt-[var(--section-spacing)] bg-heading py-14 text-background sm:py-20">
      <Container>
        <div className="grid gap-12 border-b border-white/10 pb-12 lg:grid-cols-[1.25fr_0.75fr] lg:gap-20 lg:pb-16">
          <div>
            <Image src="/brand/alcancemos-logo-light.png" alt="Alcancemos" width={2757} height={500} className="h-auto w-[220px] sm:w-[260px]" />
            <h2 className="mt-9 max-w-2xl text-balance text-4xl font-semibold leading-tight tracking-[-0.045em] sm:text-5xl">Alcancemos lo que <em className="font-display font-medium italic">Tú Competencia</em> no puede</h2>
          </div>
